...
namespace Edam.Data
{
   ...
   public class LocalDatabaseConnection : IDisposable
   {
      ...
      private static LocalDatabaseConnection m_Instance;
      ...
      {
         if (m_Instance == null)
            m_Instance = new LocalDatabaseConnection();
      ...
      public Task<CreateTableResult> CreateTableAsync<T>() 
         where T : ILocalDatabaseObject, new()
      {
      ...
      public Task<List<T>> GetAsync<T>(
         ...
         where T : ILocalDatabaseIdNoObject, ILocalDatabaseObject, new()
      {
