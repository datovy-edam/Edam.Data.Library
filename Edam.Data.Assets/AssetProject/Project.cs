   ...
   public class Project
   {
         ...
         string projectsPath = null)
      {
         ...
         try
         {
            ...
            results.Instance = Directory.GetCurrentDirectory();
            results.Succeeded();
         }
         catch(Exception ex)
         {
      ...
      public static FolderFileItemInfo GetProjectItems()
      {
         ...
         return FolderFileReader.GetFolderFileInfo(results.Instance);
      }
      ...
      public static FolderFileItemInfo GetProjectItems(string rootFilePath)
      {
         ...
         try
         {
            finfo = FolderFileReader.GetFolderFileInfo(results.Instance);
         }
         catch (Exception ex)
         {
            results.Failed(ex);
