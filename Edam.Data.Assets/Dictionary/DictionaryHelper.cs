         ...
         foreach (string token in tokens)
         {
            ...
            if (entry != null)
            {
               ...
               if (String.IsNullOrWhiteSpace(entry.Definition))
               {
                  ...
                  {
                     entry.Definition = results.Instance.Definition;
                     entry.Category = results.Instance.Category;
                     entry.Status = results.Instance.Status;
                     entry.UpdatedDate = results.Instance.UpdatedDate;
                  }
               }
