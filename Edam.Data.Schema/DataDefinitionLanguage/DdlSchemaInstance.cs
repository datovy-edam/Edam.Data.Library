...
namespace Edam.Data.Schema.DataDefinitionLanguage
{
   ...
   public class DdlSchemaInstance
   {
         ...
         AssetConsoleArgumentsInfo arguments)
      {
         ...
         results2.Instance = ToDataAsset(results1.Instance, l, arguments.Name, true);
         if (arguments.AssetDataItems == null)
         {
            arguments.AssetDataItems = new AssetDataList();
         }
         arguments.AssetDataItems.Add(results2.Instance);
         results2.Succeeded();
         return results2;
      }
      ...
      public static void ToFile(AssetConsoleArgumentsInfo arguments)
      {
         ...
         DdlSchemaInstance.ToFile(results.Instance, arguments, l);
      }
         ...
         AssetConsoleArgumentsInfo arguments)
      {
         ...
         try
         {
            ...
            if (d.Success)
            {
               results.Instance = new DdlSchemaSet(d.Instance, arguments);
               results.Succeeded();
            }
         }
         catch(Exception ex)
